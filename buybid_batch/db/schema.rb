...
ActiveRecord::Schema.define(version: 2019_06_11_085757) do
  ...
  create_table "buybid_batch_market_settings", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "setting_key"
    t.text "setting_values", limit: 4294967295
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "buybid_batch_time_schedules", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "buybid_seller_logo", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "buybid_seller_id"
    t.bigint "spree_asset_id"
    t.index ["buybid_seller_id"], name: "index_buybid_seller_logo_on_buybid_seller_id"
    t.index ["spree_asset_id"], name: "index_buybid_seller_logo_on_spree_asset_id"
  end

  create_table "buybid_seller_taxons", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "buybid_seller_id"
    t.bigint "spree_taxon_id"
    t.integer "position"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["buybid_seller_id"], name: "index_buybid_seller_taxons_on_buybid_seller_id"
    t.index ["spree_taxon_id"], name: "index_buybid_seller_taxons_on_spree_taxon_id"
  end

  create_table "buybid_sellers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name"
    ...
    t.integer "auction", default: 0
    t.integer "shop", default: 0
    ...
    t.index ["position"], name: "index_buybid_sellers_on_position"
  end
  ...
  create_table "spree_addresses", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.bigint "buybid_seller_id"
    t.index ["buybid_seller_id"], name: "index_spree_addresses_on_buybid_seller_id"
  ...
  create_table "spree_oauth_access_grants", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "spree_oauth_access_tokens", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "spree_oauth_applications", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name", null: false
  ...
  create_table "spree_pages", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "title"
    t.text "body"
    t.string "slug"
    t.datetime "created_at", null: false
  ...
  create_table "spree_pages_stores", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "store_id"
    t.integer "page_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "spree_products", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "meta_title"
    t.string "buybid_market_name"
    t.string "buybid_url_original"
    t.integer "buybid_position"
    t.bigint "buybid_seller_id"
    t.string "buybid_product_code"
    t.string "buybid_headline"
    t.integer "buybid_auction", default: 0
    t.integer "buybid_shop", default: 0
    t.integer "buybid_partner", default: 0
    t.integer "buybid_store", default: 0
    t.integer "buybid_hot", default: 0
    t.integer "buybid_new", default: 0
    t.integer "buybid_popular", default: 0
    t.index ["available_on"], name: "index_spree_products_on_available_on"
    t.index ["buybid_seller_id"], name: "index_spree_products_on_buybid_seller_id"
  ...
  add_foreign_key "spree_addresses", "buybid_sellers"
  ...
  add_foreign_key "spree_products", "buybid_sellers"
end
